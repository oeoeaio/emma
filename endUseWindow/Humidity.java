...
public class Humidity extends Source{
	String sourceID;
	String sourceName;
	String roomID;
	String notes;
	...
	public Humidity(Site site,String sourceID,String sourceName,String roomID,String notes){
		super(site,sourceID,sourceName,"Humidity","");
