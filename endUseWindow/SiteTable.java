		...
		public void run(){
			try {
				...
				if (siteRS.next()){
					...
					while (siteRS.next()){
						siteList.add(new Site(siteRS.getString("site_id"),siteRS.getString("site_name"),siteRS.getString("given_name"),siteRS.getString("surname"),siteRS.getString("suburb"),siteRS.getString("state")));
					}
