		...
		public void run(){
			try {
				...
				if (sourceRS.next()){
					...
					while (sourceRS.next()){
						sourceList.add(new Source((site==null?new Site(sourceRS.getString("site_id"),sourceRS.getString("site_name"),sourceRS.getString("given_name"),sourceRS.getString("surname"),sourceRS.getString("suburb"),sourceRS.getString("state")):site),sourceRS.getString("source_id"),sourceRS.getString("source_name"),sourceRS.getString("source_type"),sourceRS.getString("measurement_type")));
					}
