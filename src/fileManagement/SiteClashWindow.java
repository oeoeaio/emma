...
public class SiteClashWindow extends JFrame implements ActionListener {
	...
	JRadioButton o1Button = new JRadioButton("<html>Existing information<br>(below) for this site is<br>correct.</html>");
	//Option 2 Panel
	JPanel o2Panel = new JPanel(new BorderLayout());
	JPanel o2InfoPanel = new JPanel(new GridLayout(0,1));
	JLabel o2Label = new JLabel("");
	JRadioButton o2Button = new JRadioButton("<html>The conflicting information<br>(below) for this site is<br>correct.</html>");
	//Option 3 Panel
	...
	void buildGUI(String siteID, Site existing, Site conflicting){
		...
		topLabel.setText("A mismatch in information has been detected for site "+siteID+". Please select an option to resolve this conflict.");
		...
		o1InfoPanel.add(new JLabel("Site Name: "+existing.getSiteName()));
		o1InfoPanel.add(new JLabel("Given Name: "+existing.getGivenName()));
		o1InfoPanel.add(new JLabel("Surname: "+existing.getSurname()));
		o1InfoPanel.add(new JLabel("Suburb: "+existing.getSuburb()));
		o1InfoPanel.add(new JLabel("State: "+existing.getState()));
		...
		o2InfoPanel.add(new JLabel("Site Name: "+conflicting.getSiteName()));
		o2InfoPanel.add(new JLabel("Given Name: "+conflicting.getGivenName()));
		o2InfoPanel.add(new JLabel("Surname: "+conflicting.getSurname()));
		o2InfoPanel.add(new JLabel("Suburb: "+conflicting.getSuburb()));
		o2InfoPanel.add(new JLabel("State: "+conflicting.getState()));
	...
	int getSelectedOption(final String siteID,final Site existing,final Site conflicting){
		SwingUtilities.invokeLater(new Runnable(){
			public void run(){
				buildGUI(siteID,existing,conflicting);
			}
		});
