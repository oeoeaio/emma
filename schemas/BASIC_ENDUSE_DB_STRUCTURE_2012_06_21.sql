...
CREATE TABLE IF NOT EXISTS `appliances` (
  ...
  `gpo_id` smallint(5) unsigned DEFAULT NULL,
  ...
  KEY `room_id` (`room_id`),
  KEY `gpo_id` (`gpo_id`),
  CONSTRAINT `FK_appliances_gpos` FOREIGN KEY (`gpo_id`) REFERENCES `gpos` (`gpo_id`) ON DELETE CASCADE ON UPDATE CASCADE,
